    ...
    <AppShell title="Analytics" subtitle="Métricas de uso e eficiência da IA">
      <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-4">
        <StatCard
          ...
          value={overview.queriesCount.toLocaleString("pt-BR")}
          icon={BarChart3}
          accent="primary"
        />
        <StatCard
          label="Tempo médio resposta"
          value={`${overview.avgResolutionMinutes}s`}
          icon={Timer}
          accent="info"
        />
        <StatCard
          label="Documentos"
          value={overview.documentsCount.toString()}
          icon={Sparkles}
          accent="success"
        />
        <StatCard
          label="Uploads"
          value={overview.uploadsCount.toString()}
          icon={Upload}
          accent="warning"
        />
      </div>
